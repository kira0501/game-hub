...
<section class="hub-container flex min-h-[70vh] items-center justify-center py-10">
    <form method="POST" action="{{ route('register') }}" class="hub-panel w-full max-w-md space-y-4 p-6">@csrf
        ...
        <input name="name" value="{{ old('name') }}" class="hub-input" placeholder="Имя" required>
        <input name="email" type="email" value="{{ old('email') }}" class="hub-input" placeholder="Email" required>
        <div class="relative">
            <input id="register-password" name="password" type="password" class="hub-input pr-28" placeholder="Пароль" minlength="8" required>
        ...
        <div class="relative">
            <input id="register-password-confirmation" name="password_confirmation" type="password" class="hub-input pr-28" placeholder="Повторите пароль" minlength="8" required>
